...
class Engine(rocket_components.Component):
    ...
    def __init__(self, ts=[], Ts=[], manufacturer=None, model=None, delays=None, propellent_mass=0, empty_mass=0, t_start=0, comments=None, src=None):
        ...
        for eng in engs:
            if eng is not None: # NOTE: IF WORKING PROPERLY, THE ENGINE SHOULD NEVER BE NULL
                ...
                if True:
                    ...
                    label = '{} {} {}'.format(manufacturer, model, eng.src)
