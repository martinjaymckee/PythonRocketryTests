...
import rocket_components as rkc
...
if __name__ == '__main__':
    ...
    engine = rkc.Engine('Estes_A3.eng')
    t_delay = 4
    print('Prop Weight = {} g'.format(1000*engine.prop_weight))
    ...
    axs[0].axvline(engine.t_max, c='k', alpha=0.8)
    ...
    print('Optimum Delay = {}'.format(result.t_apogee - engine.t_max))
    ...
    print('Actual Motor Burnout = {} s'.format(engine.t_max))
